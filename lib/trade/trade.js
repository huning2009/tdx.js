...
class TradeApi {
    ...
    async queryHistoryData(clientId, category, beginDate, endDate) {
        return await this.callApi('query_history_data', {
            'client_id': clientId,
            'category': category,
    ...
    async queryDatas(clientId, categories) {
        return await this.callApi('query_datas', {
            'client_id': clientId,
            'categories': categories
        })
    }

    async getQuotes(clientId, codes) {
        return await this.callApi('get_quotes', {
            'client_id': clientId,
            'zqdms': codes
        })
    }

    async sendOrders(clientId, orders) {
        return await this.callApi('send_orders', {
            'client_id': clientId,
            'orders': orders        
        })
    }

    async cancelOrders(clientId, orders) {
        return await this.callApi('cancel_orders', {
            'client_id': clientId,
            'orders': orders
        })
    }
    ...
    async getActiveClients() {
        return await this.callApi('get_active_clients', null)
    }
